module.exports.createHelpers = function createHelpers(app){
  return {
    ...
    // 加入google的统计的代码片段.
    globalDpl: function () {
      var templates = require('./hogan.js').templates,
          staticroot = this.urlForStatic();
      return {
          globaljs: ['http://g.tbcdn.cn/kissy/k/1.3.0/kissy-min.js',
                staticroot + '/global/global.js'],
          globalcss: [staticroot + '/global/base.css',
                staticroot + '/global/global.css'],
          header: templates['./src/global/header.html'],
          footer: templates['./src/global/footer.html']
        };
    }
  }
}
