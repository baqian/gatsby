...
var options    = require('../jsbin/lib/config'),
    store      = require('../jsbin/lib/store')(options.store),
    routes     = require('../jsbin/lib/routes'),
    handlers   = require('../jsbin/lib/handlers'),
    utils      = require('../jsbin/lib/utils');
